...
•	R version 3.6.0 (2019-04-26) -- "Planting of a Tree" (language)
•	Copyright (C) 2019 The R Foundation for Statistical Computing
•	R Studio Server Swanson Computer port 8787, v1.2.5001 (server application)
o	Stringr version 1.4.0
o	Dyplr version 0.8.3
o	Ggplot2 version 3.2.1
o	Ggseqlogo version 0.1
o	Gtools version 3.8.1
o	Scales version 1.1.0
•	bcl2fastq v2.20.0.422 Copyright (c) 2007-2017 Illumina, Inc.
•	Immcantation Programs
o	pRESTO version 0.5.13 (program on server)
o	Changeo version 0.4.5 (program on server)
o	Alakazam version 0.3.0 (program on server)
o	RDI version 1.0.0 (program on server)
•	IMGT/HighV-Quest version 1.6.7 (web-based IMGT portal)
•	Devtools version 2.2.1
•	Xml 2 version 1.2.2
•	Dependencies for Immcantation programs
o	Python version 3.7.2
o	Biopython version 1.7.3
o	setuptools version 2.0
o	NumPy version 1.8
o	SciPy version 0.14
o	pandas version 0.15
o	airr version 1.2.1
o	Phylip version 3.697
